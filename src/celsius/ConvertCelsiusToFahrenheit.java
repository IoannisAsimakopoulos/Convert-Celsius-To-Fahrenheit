...
public class ConvertCelsiusToFahrenheit extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CovertCelsiusToFahrenheit
     */
    ...
    private void initComponents() {
        ...
        jPanel2.setForeground(new java.awt.Color(204, 229, 255));

        jButton1.setBackground(new java.awt.Color(92, 169, 224));
        jButton1.setText("Μετατροπή");
        ...
        jLabel1.setText("Βαθμοί Celius");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel2.setText("Βαθμοί Fahrenheit");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            jLabel2.setText(tempFahr+" Βαθμοί Fahrenheit");
        }
        catch (Exception e)
        {
           JOptionPane.showMessageDialog(null,"Παρακαλώ συμπληρώστε την θερμοκρασία για μετατροπή...    ");
        }
